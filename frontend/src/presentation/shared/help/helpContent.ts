...
export const helpEntries: readonly HelpEntry[] = [
  ...
  },
  {
    ...
    question: '준비 중이라고 표시된 기능은 언제 되나요?',
    title: '준비 중 배지가 붙은 기능',
    summary: '준비 중 배지가 붙은 버튼은 아직 동작하지 않습니다.',
    body: [
      '화면에 자리는 있지만 아직 만들지 않은 기능에는 준비 중 배지를 붙입니다. 관심 공고함 연동, 모집글 저장, 회원 목록 내보내기가 여기에 해당합니다.',
      '배지가 붙은 버튼은 눌러도 아무 일이 일어나지 않습니다. 되는 것처럼 안내하지 않으려고 배지를 남겨 둡니다.',
    ],
    limitation: '준비 중 기능에는 대체 경로가 없고 공개 일정도 아직 없습니다.',
    status: 'preparing',
